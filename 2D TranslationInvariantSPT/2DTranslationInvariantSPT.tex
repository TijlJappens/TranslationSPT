...
\begin{proof}
	...
	\begin{align}
		...
		\tilde{K}_g^\sigma&=\pi_0(A_1)v^\dagger \delta_g^\sigma v K_g^\sigma \delta_g^\sigma \pi_0(A_1)^\dagger
	\end{align}
...
\begin{lemma}\label{lem:DefinitionOfGroupMorphismTwoTranslations}
	...
	\begin{align}
		\phi_1&:\textrm{IAC}_{R}(\alpha_0,\theta,\Theta) \rightarrow \UU(\HH)\\
		\nonumber
...
\end{proof}
\begin{lemma}
	There exists an $\epsilon^L_g\in\textrm{IAC}_L(\alpha_0,\theta)$ and an $\epsilon^R_g\in\textrm{IAC}_R(\alpha_0,\theta)$ satisfying
	\begin{align}
