...
\begin{lemma}\label{lem:DefinitionOfGroupMorphism}
	...
	\end{equation}
	This can be done using lemma \ref{lem:PropertiesLocallyGeneratedAutomorphisms} part 2. There now exists a group homomorphism
	\begin{equation}
		\phi_1:\textrm{IAC}_R(\alpha_0,\theta,\Theta) \rightarrow \textrm{IAC}_R(\alpha_0,\theta,\Theta\circ \Phi^U_{0;1}\otimes\Phi^D_{0;1}):x\mapsto \phi_1(x)
	\end{equation}
	...
	\end{equation}
	This group morphism is unique {\color{red}At least I think so, it might be only unique up to a phase but I'm not sure.}
\end{lemma}
\begin{proof}
