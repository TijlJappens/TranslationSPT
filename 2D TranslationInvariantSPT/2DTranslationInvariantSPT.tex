...
\begin{lemma}\label{lem:PropertiesLocallyGeneratedAutomorphisms}
	...
	\begin{enumerate}
		...
		\item $\gamma^{-1}\circ\beta_g^U\circ\gamma\circ(\beta_g^U)^{-1}\in\textrm{HAut}(\AA)$.
	\end{enumerate}
\end{lemma}
\begin{proof}
	content...
...
\begin{lemma}\label{lem:TwoAngleLemmaPart1}
	Take $\theta_1$ and $\theta_2$ such that $0<\theta_1<\theta_2<\pi/2$ then for all $\Theta\in\Aut{\AA_{(C_{\theta_2}\cup \tau(C_{\theta_2}))^c}}$ there exists an $a_1\in\UU(\AA)$ and an $\tilde{\Theta}\in \Aut{\AA_{(C_{\theta_1}\cup \tau(C_{\theta_1}))^c}}$
