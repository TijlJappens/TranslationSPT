...
\begin{proof}
	...
	\end{equation}
	Using lemma \ref{lem:TwoAngleLemma} part 1 for $\theta_2=\pi/2$ we get that there exists a $\Theta_2$ acting on the same subspace as $\Theta$ satisfying that there exists an $a\in\AA$ such that
