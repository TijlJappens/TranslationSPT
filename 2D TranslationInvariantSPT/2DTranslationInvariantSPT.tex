...
\begin{lemma}\label{lem:TwoAngleLemma}
	...
	\begin{enumerate}
		...
		\end{equation}
		\item $\eta_{g,1}^{L/R}\in\Aut{\AA_{C_{\theta_1}}\cup\AA_{L/R}}$ there exists an $a_2\in\UU(\AA)$ and some $\eta_{g,2}^{L/R}\in\Aut{\AA_{C_{\theta_2}}\cup\AA_{L/R}}$ such that
		\begin{equation}
...
\begin{proof}
	...
	\alpha=\Ad{V_1}\circ\alpha_L\otimes\alpha_R\circ\Theta.
	\end{equation}
	Take $\tilde{\beta}_g$ such that $\omega\circ\tilde{\beta}_g=\omega$ and such that there exists some $V_{2,g}\in\UU(\AA)$ and some $\eta_g^{L/R}\in\Aut{\AA_{C_{\theta_1}}\cap\AA_{L/R}}$ satisfying
	\begin{equation}
		\tilde{\beta}_g=\Ad{V_{2,g}}\circ\eta_{g}^L\otimes\eta_{g}^R\circ\beta_g^U.
	\end{equation}
	...
	\end{equation}
	Combining lemma \ref{lem:TwoAngleLemma} part 2 with lemma \ref{lem:GroupActionInCone} we get that there exist some $\hat{\eta}^{L/R}_g\in\Aut{\AA}$
\end{proof}
\bibliography{TSPT}
