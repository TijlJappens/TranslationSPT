...
\end{proof}
\begin{lemma}
	Take $\gamma^{L/R}\in\Aut{(\AA_{C_\theta}\cup\AA_{C_\theta'})\cap\AA_{L/R}}$ and take $\Gamma^{L/R}$ to be such that
	\begin{equation}
...
\begin{lemma}\label{lem:AdjointOverConeIsInCone}
	...
	\begin{equation}
		...
		R(g,h)}\circ\pi_R=\Ad{v^\dagger u_R(g,h)v}\circ\pi_R.
	\end{equation}
\end{lemma}
\begin{proof}
	...
	\begin{align}
		&(K_g^L\otimes K_g^R)\Ad{W_g}\left((K_h^L\otimes K_h^R)\Ad{W_h}\left((K_{gh}^L\otimes K_{gh}^R)^{-1}\right)\right)\\
		&=K_g^L\Ad{W_g}\left(K_h^L\Ad{W_h}\left((K_{gh}^L)^{-1}\right)\right)\otimes K_g^R\Ad{W_g}\left(K_h^R\Ad{W_h}\left((K_{gh}^R)^{-1}\right)\right)
	\end{align}
