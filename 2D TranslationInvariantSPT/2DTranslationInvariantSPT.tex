...
\begin{lemma}
	Take $\eta_{g,1}^L,\eta_{g,2}^L\in \Aut{\AA_L\cap\AA_{C_\theta}}$ and $\eta_{g,1}^R,\eta_{g,2}^R\in \Aut{\AA_R\cap\AA_{C_\theta}}$ such that there exist $V_{21},V_{22}\in\UU(\AA)$ satisfying
	\begin{equation}
		\tilde{\beta}_g=\Ad{V_{21}}\circ\eta_{g,1}\circ\beta^U_g=\Ad{V_{22}}\circ\eta_{g,2}\circ\beta^U_g
	\end{equation}
	then
	\begin{equation}
...
\end{lemma}
\begin{proof}
	Take $\Delta_L\in\UU(\AA_L)$ and $\Delta_R\in\UU(\AA_L)$ to be such that
	\begin{equation}
		\Delta_L\otimes\Delta_R = \eta_{g,1}\circ(\eta_{g,2})^{-1}=\Ad{V_{21}^\dagger V_{22}}.
	\end{equation}
\end{proof}
