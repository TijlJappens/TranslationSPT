...
\end{equation}
be the horizontal cone. We will use $\tau$ to denote the automorphism that moves every element one site upward. Of course this is only an automorphism if the $C^*$ algebra is translation invariant in the vertical direction which we will assume.
...
\begin{definition}
	Take $0<\theta<\pi/2$ and $\alpha_\sigma\in\Aut{\AA_{\sigma}}$. Take $x\in\UU(\HH_{R/L})\otimes\mathbbm{1}_{\HH_{L/R}}$ then we say that $x$ is a cone operator on the right/left (or in short $x\in\textrm{Cone}_{\sigma}(\alpha_0,\theta)$ for $\sigma\in\{L,R\}$) if there exists a $\xi\in\Aut{(\AA_{C_\theta}\cup\tau(\AA_{C_\theta}))\cap\AA_\sigma}$ such that
	\begin{equation}
...
\begin{definition}
	Take $0<\theta<\pi/2$, $\alpha_\sigma\in\Aut{\AA_{\sigma}}$ and $\Theta\in\Aut{(\AA_{C_\theta}\cup\tau(\AA_{C_\theta}))^c}$. Take $x\in\UU(\HH_0)$ then we say that $x$ is an inner after cone operator on the right (or in short $x\in \textrm{IAC}_R(\alpha_0,\theta,\Theta)$) if there exists an $A\in\AA_R$ and a $y\in\textrm{Cone}_R(\alpha_0,\theta)$ such that
	\begin{equation}
...
\end{lemma}
\begin{proof}
	Take $\tilde{\Xi}^\sigma$ such that $\Xi^\sigma=\tilde{\Xi}^\sigma\otimes\mathbbm{1}_{\HH_{\sigma^c}}$. Take $\xi_\sigma\in\Aut{\AA_{C_\theta}\cap\AA_\sigma}$ such that
	\begin{equation}
