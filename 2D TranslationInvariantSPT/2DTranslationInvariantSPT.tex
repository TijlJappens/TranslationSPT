...
\begin{lemma}
	...
	\begin{equation}
		v^\dagger W_g v W_g^\dagger=K_g^L\otimes K_g^R
	\end{equation}
	and they are unique (up to a phase). They satisfy the identity
	\begin{equation}
		\Ad{K^R_g}\circ\pi_0=\pi_0\circ \alpha_0 \tau^{-1}\circ \eta_g^R\circ\beta_g^{RU}\circ\tau\circ\beta_g^{RU\:-1}\circ\eta_g^{R\:-1}\circ\alpha_0^{-1}.\quad\footnote{Observe in particular that $\Theta$ has cancelled out}
	\end{equation}
\end{lemma}
\begin{proof}
	content...
