...
\begin{lemma}\label{lem:Bound3}
	Take $0<\theta<\pi/2$. Take $H$ to be an arbitrary $t-$dependent $f$-local interaction. Take $\gamma_t$ to be the automorphism generated by $H$ up to time $t$. For any $0<n_0<n_1<n_2$ take $\Phi_{n_0/2}$ and $\Psi_{n_1,n_2}$ to be $f-$local interactions such that
	\begin{enumerate}
