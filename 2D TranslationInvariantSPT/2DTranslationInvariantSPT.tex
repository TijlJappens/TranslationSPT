...
\maketitle	
\begin{abstract}
	We consider SPT-phases with on-site $G$ (where $G$ is a topological group) symmetry for two-dimensional quantum spin systems. We then impose translation invariance in one direction and observe that on top of the $H^3(G,\TT)$-valued index constructed in \cite{ogata2021h3gmathbb} an additional $H^2(G,\TT)$-valued index emerges. We also show that if we impose translation invariance in two directions, on top of the expected $H^3(G,\TT)\oplus H^2(G,\TT)\oplus H^2(G,\TT)$ valued index an additional $H^1(G,\TT)$-valued index emerges.
\end{abstract}
...
\end{lemma}
\begin{proof}
	In this proof we will define (for notational simplicity) $H_{\text{split}}\defeq H_{\nu^{-1}(L)}+H_{\nu(R)}$. We have that
	\begin{align}
		&\Ad{w^\dagger \phi_2(W_g)w\phi_2(w^\dagger W_g w)^\dagger}\circ\pi_0\circ\alpha_0\circ\Theta\\
		&=\pi_0\circ\alpha_0\circ\Theta\circ\nu^{-1}\circ\gamma^H_{0;1}\circ\gamma^{H_{\text{split}}}_{1;0}\circ\eta_g\circ\beta_g^U\circ\gamma^{H_{\text{split}}}_{0;1}\circ\stkout{\gamma^H_{1;0}}\circ\nu\\
		\nonumber
		&\quad \circ\stkout{\gamma^H_{0;1}}\circ\gamma^{H_{\text{split}}}_{1;0}\circ\nu^{-1}\circ(\beta_g^U)^{-1}\circ\eta_g^{-1}\circ\nu\circ\gamma^{H_{\text{split}}}_{0;1}\circ\gamma^H_{1;0}.
	\end{align}
	Using on this the fact that
	\begin{align}
		\nu^{-1}\circ\gamma^H_{0;1}&=\gamma^H_{0;1}\circ\nu^{-1}=\gamma^H_{0;1}\circ\gamma^{H_{\text{split}}}_{1;0}\circ\gamma^{H_{\text{split}}}_{0;1}\circ\nu^{-1}\\
		&=\gamma^H_{0;1}\circ\gamma^{H_{\text{split}}}_{1;0}\circ\nu^{-1}\circ\nu\circ\gamma^{H_{\text{split}}}_{0;1}\circ\nu^{-1}
	\end{align}
	gives us
	\begin{align}
		&=\pi_0\circ\alpha_0\circ\Theta\circ\gamma^H_{0;1}\circ\gamma^{H_{\text{split}}}_{1;0}\circ\nu^{-1}\circ\left(\nu\circ\gamma^{H_{\text{split}}}_{0;1}\circ\nu^{-1}\circ\gamma^{H_{\text{split}}}_{1;0}\right)\circ\eta_g\circ\beta_g^U\\
		\nonumber
		&\quad \circ\left(\gamma^{H_{\text{split}}}_{0;1}\circ\nu\circ\gamma^{H_{\text{split}}}_{1;0}\circ\nu^{-1}\right)\circ(\beta_g^U)^{-1}\circ\eta_g^{-1}\circ\nu\circ\gamma^{H_{\text{split}}}_{0;1}\circ\gamma^H_{1;0}\\
		\label{eq:ExistenceOfEpsilonProofEquationOne}
		&=\pi_0\circ\alpha_0\circ\Theta\circ\gamma^H_{0;1}\circ\gamma^{H_{\text{split}}}_{1;0}\circ\nu^{-1}\circ\left(\nu\circ\gamma^{H_{\text{split}}}_{0;1}\circ\nu^{-1}\circ\gamma^{H_{\text{split}}}_{1;0}\right)\circ\eta_g\circ\beta_g^U\\
		\nonumber
		&\quad \circ\left(\nu\circ\gamma^{H_{\text{split}}}_{0;1}\circ\nu^{-1}\circ\gamma^{H_{\text{split}}}_{1;0}\right)^{-1}\circ(\beta_g^U)^{-1}\circ\eta_g^{-1}\circ\nu\circ\gamma^{H_{\text{split}}}_{0;1}\circ\gamma^H_{1;0}.
	\end{align}
	Because of the translation invariance of the interaction, there exist $a_L\in\UU(\AA_{\nu^{-1}(L)}),a_R\in\UU(\AA_{\nu(R)})$ and $\Phi^{\mu\nu}\in\Aut{\AA_{W(C_\theta)^c\cap\mu\cap\nu}}$ where $\mu\in\{U,D\}$ and $\nu\in\{\nu^{-1}(L),\nu(R)\}$ satisfying that
	...
	\end{align}
	This can be done by simply taking
	\begin{equation}
		\epsilon_g^\sigma\defeq \pi_0\circ\alpha_0\circ\Theta\circ\nu^{-1}(a_\sigma\:\eta_g^\sigma\circ\beta_g^{U\sigma}(a_\sigma^\dagger)).
	\end{equation}
	This concludes the proof of the first result. The proof of the second result will be done in two steps. First we will prove that there exists a $\beta:G\rightarrow U(1)$ such that
	\begin{equation}
		\beta(g) w^\dagger \phi_1(K_g^\sigma)w =v^\dagger \phi_1(\epsilon_g^\sigma)v\phi_1(w^\dagger K_g^\sigma w)\phi_1(\epsilon_g^\sigma)^\dagger=\phi_1(v^\dagger\epsilon_g^\sigma v\: w^\dagger K_g^\sigma w\:(\epsilon_g^\sigma)^\dagger).
	\end{equation}
	To do this we only have to show that
	\begin{equation}
		\Ad{w^\dagger \phi_1(K_g^\sigma)w}\circ\pi_0\circ\alpha_0\circ\Theta=\Ad{\phi_1(v^\dagger\epsilon_g^\sigma v\: w^\dagger K_g^\sigma w\:(\epsilon_g^\sigma)^\dagger)}\circ\pi_0\circ\alpha_0\circ\Theta.
	\end{equation}
	We will first write out the left hand side, this gives:
	\begin{align}
		&\Ad{w^\dagger \phi_1(K_g^\sigma)w}\circ\pi_0\circ\alpha_0\circ\Theta\\
		&=\pi_0\circ\alpha_0\circ\Theta\circ\nu^{-1}\circ\gamma^H_{0;1}\circ\gamma^{H_{\text{split}}}_{1;0}\circ\tau^{-1}\circ\eta_g^R\circ\beta_g^{RU}\\
		\nonumber
		&\qquad\circ\tau\circ(\beta_g^{RU})^{-1}\circ(\eta_g^R)^{-1}\circ\gamma^{H_{\text{split}}}_{0;1}\circ\gamma^H_{1;0}\circ\nu\\
		&=\pi_0\circ\alpha_0\circ\Theta\circ(\gamma_{0;1}^H\circ\gamma_{1;0}^{H_{\text{split}}}\circ\gamma_{0;1}^{H_{\text{split}}}\circ\stkout{\gamma_{1;0}^H})\circ\nu^{-1}\circ\stkout{\gamma^H_{0;1}}\circ\gamma^{H_{\text{split}}}_{1;0}\circ\tau^{-1}\circ\eta_g^R\circ\beta_g^{RU}\\
		\nonumber
		&\qquad\circ\tau\circ(\beta_g^{RU})^{-1}\circ(\eta_g^R)^{-1}\circ\gamma^{H_{\text{split}}}_{0;1}\circ\stkout{\gamma^H_{1;0}}\circ\nu\circ(\stkout{\gamma_{0;1}^H}\circ\gamma_{1;0}^{H_{\text{split}}}\circ\gamma_{0;1}^{H_{\text{split}}}\circ\gamma_{1;0}^H)\\
		&=\pi_0\circ\alpha_0\circ\Theta\circ\gamma_{0;1}^H\circ\gamma_{1;0}^{H_{\text{split}}}\circ\nu^{-1}\circ(\nu\circ\gamma_{0;1}^{H_{\text{split}}}\circ\nu^{-1}\circ\gamma^{H_{\text{split}}}_{1;0})\circ\tau^{-1}\circ\eta_g^R\circ\beta_g^{RU}\\
		\nonumber
		&\qquad\circ\tau\circ(\beta_g^{RU})^{-1}\circ(\eta_g^R)^{-1}\circ(\gamma^{H_{\text{split}}}_{0;1}\circ\nu\circ\gamma_{1;0}^{H_{\text{split}}}\circ\nu^{-1})\circ\nu\circ\gamma_{0;1}^{H_{\text{split}}}\circ\gamma_{1;0}^H.
	\end{align}
	Using the fact that $\nu\circ\gamma_{0;1}^{H_{\text{split}}}\circ\nu^{-1}\circ\gamma^{H_{\text{split}}}_{1;0}$ commutes with $\tau$ and filling in $(\nu\circ\gamma_{0;1}^{H_{\text{split}}}\circ\nu^{-1}\circ\gamma^{H_{\text{split}}}_{1;0})\circ(\nu\circ\gamma_{0;1}^{H_{\text{split}}}\circ\nu^{-1}\circ\gamma^{H_{\text{split}}}_{1;0})^{-1}=\textrm{Id}$ gives:
	\begin{align}
		&=\pi_0\circ\alpha_0\circ\Theta\circ\gamma_{0;1}^H\circ\gamma_{1;0}^{H_{\text{split}}}\circ\nu^{-1}\circ\tau^{-1}\circ(\nu\circ\gamma_{0;1}^{H_{\text{split}}}\circ\nu^{-1}\circ\gamma^{H_{\text{split}}}_{1;0})\circ\eta_g^R\circ\beta_g^{RU}\\
		\nonumber
		&\qquad (\nu\circ\gamma_{0;1}^{H_{\text{split}}}\circ\nu^{-1}\circ\gamma^{H_{\text{split}}}_{1;0})^{-1}\circ\tau\circ(\nu\circ\gamma_{0;1}^{H_{\text{split}}}\circ\nu^{-1}\circ\gamma^{H_{\text{split}}}_{1;0})\\
		\nonumber
		&\qquad\circ(\beta_g^{RU})^{-1}\circ(\eta_g^R)^{-1}\circ(\gamma^{H_{\text{split}}}_{0;1}\circ\nu\circ\gamma_{1;0}^{H_{\text{split}}}\circ\nu^{-1})\circ\nu\circ\gamma_{0;1}^{H_{\text{split}}}\circ\gamma_{1;0}^H.
	\end{align}
	Filling in equation \eqref{eq:TranslatingSplittedTimeEvolution} now yields:
	\begin{align}
		&=\pi_0\circ\alpha_0\circ\Theta\circ\gamma_{0;1}^H\circ\gamma_{1;0}^{H_{\text{split}}}\circ\nu^{-1}\circ\tau^{-1}\circ(\Ad{\stkout{a_L}\otimes a_R}\circ\stkout{\Phi})\circ\eta_g^R\circ\beta_g^{RU}\\
		\nonumber
		&\qquad (\stkout{\Phi^{-1}}\circ\Ad{\stkout{a_L^\dagger}\otimes a_R^\dagger})\circ\tau\circ(\Ad{\stkout{a_L}\otimes a_R}\circ\stkout{\Phi})\\
		\nonumber
		&\qquad\circ(\beta_g^{RU})^{-1}\circ(\eta_g^R)^{-1}\circ(\stkout{\Phi^{-1}}\circ\Ad{\stkout{a_L^\dagger}\otimes a_R^\dagger})\circ\nu\circ\gamma_{0;1}^{H_{\text{split}}}\circ\gamma_{1;0}^H\\
		&=\Ad{v^\dagger\phi_1(\epsilon_g^\sigma)v\phi_1(w^\dagger K_g^\sigma w)\phi_1(\epsilon_g^\sigma)^\dagger}\circ\pi_0\circ\alpha_0\circ\Theta.
	\end{align}
	We now have to show that $\beta(g)=1$. {\color{red}I still need to prove the second result.}
\end{proof}
\begin{theorem}
...
\begin{proof}
	...
	\begin{align}
		\gamma^\Phi_{0;1}&=(\text{inner})\circ\bigotimes_{i=1}^4\gamma^{\Phi_i}_{0;1}\circ\Theta&\pi_0&=\bigotimes_{i=1}^4\pi_{0,i}
	\end{align}
