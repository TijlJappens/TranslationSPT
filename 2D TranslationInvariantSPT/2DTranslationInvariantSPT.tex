...
\begin{proof}
	...
	\end{equation}
	We will now show that $\alpha\in\textrm{QAut}(\AA)$. To do this, take $0<\theta<\pi/2$ and define $\Theta\in\Aut{\AA_{W(C_\theta)^c}}$ to be
	\begin{equation}
	...
	\end{equation}
	There now exists an..{\color{red}to be continued}
\end{proof}
This shows that $\omega$ has a well defined 2d translation index. We will now show that $\textrm{Index}(\omega)=\textrm{Index}_1(\phi)$. {\color{red}to be continued.}
