...
\end{enumerate}
Take $(\HH_0=\HH_L\otimes\HH_R,\pi_0=\pi_L\otimes\pi_R,\Omega_L\otimes\Omega_R)$a GNS triple of $\omega_0$. Now use lemma 2.1 from Yoshiko Ogata \cite{ogata2021h3gmathbb} to define the objects $W_g$ and $u_\sigma(g,h)$ they will be the starting point for our definition. We will still need one more object before we can define our translation index:
\begin{lemma}
	...
	\begin{enumerate}
		...
		\item $\pi_0(V_1)v\pi_0(V_1^\dagger).$
	\end{enumerate}
\end{lemma}
\bibliography{TSPT}
