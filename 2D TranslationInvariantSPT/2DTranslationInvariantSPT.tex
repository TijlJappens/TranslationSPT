...
\begin{proof}
	...
	\end{equation}
	Because of lemma \ref{lem:TwoAngleLemma} there exists a $\tilde{\Theta}\in\Aut{\AA_{C_{\theta_2}}\cup\tau(\AA_{C_{\theta_2}})}$ and a $\tilde V_1\in\UU(\AA)$ such that
	\begin{equation}
		\alpha\circ\gamma_H=\Ad{\tilde V_1}\circ(\alpha_L\circ\gamma_{H_L}\otimes\alpha_R\circ\gamma_{H_R})\circ\tilde\Theta.
	\end{equation}
	If we now define the automorphism $\tilde{\beta}_{g,2}=\gamma^{-1}_H\beta_{g,1}\gamma_H$ then this indeed satisfies that $\omega\circ\gamma_H\circ\tilde{\beta}_{g,2}=\omega\circ\gamma_H$. Furthermore we also have that there exists a $\tilde V_{2,g}\in\UU(\AA)$ and some $\tilde{\eta}_g^{L/R}\in\Aut{\AA_{C_{\theta_2}}\cap\AA_{L/R}}$ such that
	\begin{equation}
	\gamma_{H}^{-1}\tilde{\beta}_g\gamma_H=\Ad{\tilde V_{2,g}}\circ\tilde{\eta}_g^L\otimes\tilde{\eta}_g^R\circ\beta_g^U.
	\end{equation}
	Since
	\begin{equation}
	\omega_0=\omega_0\circ\alpha\circ\gamma\circ\tilde{\beta}_{g,2}\circ\tilde{\beta}_{g,1}^{-1}\circ\alpha^{-1}
	\end{equation}
	we have that
	\begin{equation}
	\omega_0\qe\omega_0\circ \alpha_0\circ\gamma_L\otimes\gamma_R\circ\tilde{\Theta}\circ\tilde{\eta}_g^L\otimes \tilde{\eta}_g^R\otimes\circ(\eta_g^L\otimes\eta_g^R)^{-1}\circ\Theta^{-1}\circ\alpha_0^{-1}.
	\end{equation}
\end{proof}
\bibliography{TSPT}
