...
\end{align}
where $I'$ is just $I$ shifted upwards. Take $\gamma_H:\RR\rightarrow\Aut{\AA}$ to be the locally generated automorphism generated from this interaction. We will first need a lemma of the form
\begin{lemma}\label{lem:TwoAngleLemma}
	...
	\begin{enumerate}
		...
		\begin{equation}
		\gamma_{H_L}^{-1}\otimes\gamma_{H_R}^{-1}(s)\circ\Theta_1\circ\gamma_H(s)=\Ad{a_1}\circ\Theta_2.
		\end{equation}
		...
		\begin{equation}
		\gamma_H^{-1}(s)\circ\eta_{g,1}^L\otimes\eta_{g,1}^R\circ\gamma_H(s)=\Ad{a_2}\circ \eta_{g,2}^L\otimes\eta_{g,2}^R.
		\end{equation}
	\end{enumerate}
\end{lemma}
\begin{proof}
...
\begin{lemma}\label{lem:GroupActionInCone}
	...
	\begin{equation}
	\gamma_H^{-1}(s)\circ\beta_g^U\circ\gamma_H\circ(\beta_g^U)^{-1}=\Ad{a}\circ\eta^L_g\otimes\eta^R_g.
	\end{equation}
\end{lemma}
\begin{proof}
...
\end{proof}
\begin{theorem}
	$\textrm{index}(\omega)=\textrm{index}(\omega\circ\gamma_H(s))$
\end{theorem}
\begin{proof}
	Take Combining lemma \ref{lem:TwoAngleLemma} part 2 with lemma \ref{lem:GroupActionInCone} we get that there exist some $\hat{\eta}^{L/R}_g\in\Aut{\AA}$
\end{proof}
\bibliography{TSPT}
