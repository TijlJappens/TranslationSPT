...
\begin{proof}
	...
	\begin{equation}
		\beta(g) w^\dagger \phi_1(K_g^\sigma)w =v^\dagger \phi_1(\epsilon_g^\sigma)v\phi_1(w^\dagger K_g^\sigma w)\phi_1(\epsilon_g^\sigma)=\phi_1(v^\dagger\epsilon_g^\sigma v\: w^\dagger K_g^\sigma w\:\epsilon_g^\sigma).
	\end{equation}
	To do this we only have to show that
	\begin{equation}
		\Ad{w^\dagger \phi_1(K_g^\sigma)w}\circ\pi_0\circ\alpha_0\circ\Theta=\Ad{\phi_1(v^\dagger\epsilon_g^\sigma v\: w^\dagger K_g^\sigma w\:\epsilon_g^\sigma)}\circ\pi_0\circ\alpha_0\circ\Theta.
	\end{equation}
	...
	{\color{red}I still need to prove the second result.}
\end{proof}
\begin{theorem}
