...
\begin{lemma}\label{lem:GroupActionInCone}
	...
	\begin{enumerate}
		\item there exists an $a\in\UU(\AA)$ and some $\xi_{g}^{L/R}\in\Aut{\AA_{C_{\theta}}\cup\AA_{L/R}}$ such that
		\begin{equation}
			\gamma^{-1}\circ\beta_g^U\circ\gamma\circ(\beta_g^U)^{-1}=\Ad{a}\circ\xi^L_g\otimes\xi^R_g.
		\end{equation}
		\item there exists a $b\in\UU(\AA)$ and a $\Phi\in\Aut{\AA_{(C_\theta\cup\tau(\AA_{C_\theta}))^c}}$ such that
		\begin{equation}
			\gamma_L^{-1}\otimes\gamma_R^{-1}\circ\gamma=\Ad{b}\circ\Phi.
		\end{equation}
	\end{enumerate}
\end{lemma}
\begin{proof}
