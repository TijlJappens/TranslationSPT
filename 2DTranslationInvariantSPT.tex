...
showing that indeed $\textrm{Index}_{\text{2 trans}}(\omega_\phi)=\textrm{Index}_{\text{1d trans}}(\phi)$.
	...
	\begin{proof}
		...
		\end{align}
		By appendix \ref{lem:SplittingOfUnitary} (which is a generalization of lemma \ref{lem:UsingIrreducibilityAndWignerTheorem}), there exist $\tilde{X}_g\in\UU(\HH_{0,1}\otimes\HH_{0,2})$ and $\tilde{Y}_g\in\UU(\HH_{0,3}\otimes\HH_{0,4})$ such that
		\begin{equation}
