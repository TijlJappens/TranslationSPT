...
\end{proof}
 ...
 \begin{lemma}\label{lem:OperatorsBelongingToOmegaAfterH_TwoTranslations}
 	Of both $\omega$ and $H$ are translation invariant in both directions then, additionally to the operators presented in lemma \ref{lem:OperatorsBelongingToOmegaAfterH}, the following operators belong to $\omega\circ\gamma_{0;1}^H$ as well:
 	\begin{align}
 ...
 \end{lemma}
\begin{proof}
	The proof that the first four operators belong to $\omega\circ\gamma^H_{0;1}$ is completely analogous to what was done in the proof of theorem \ref{lem:OperatorsBelongingToOmegaAfterH} and we will therefore focus on the $\tilde{b}_g^\sigma$ part (the other two are trivial). To show this, observe that we have
	\begin{align}
...
\end{remark}
\section{}\label{sec:ProofFirstStatement}\subsection{The $H^2$-valued index is invariant of choice of basis of on site Hilbert space}\label{sec:the-h2-valued-index-is-invariant-of-choice-of-basis-of-on-site-hilbert-space}
